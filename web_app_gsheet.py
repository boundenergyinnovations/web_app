...
# Set up Google Sheets credentials put chatsheet from Google console here
scope = ['https://spreadsheets.google.com/feeds', 'https://www.googleapis.com/auth/drive']
creds = Credentials.from_service_account_file('chatsheet-xxxxxx-xxxxxxxxxx.json', scopes=scope)
